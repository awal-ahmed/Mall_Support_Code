...
def get_model(args):
    ...
    if args.n_gpus > 1 and enable_multiple_gpus:
        # To enable Multiple GPUs model loading, please adjust "n_gpus" to the desired number of graphics cards.
...
# evaluation/utils.py / Full list of supported languages in evaluation/utils.py
LANGUAGE_TAG = {
    "Abap"         : "* language: Abap",
